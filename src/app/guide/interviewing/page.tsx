...
export default function Interview() {
    ...
    return (
        <>
            <div className="w-full int-bg banner-bg bg-no-repeat bg-contain bg-right-bottom"> 
                <div className='w-2/5 flex flex-col  items-start justify-center p-2.5 h-max'>
                    <h1 className='text-white text-6xl'>
                        Cover letter
                    </h1>
                    <p className='text-white text-base mt-6'>
                    Job interviews can be stressful. It&apos;s the time when you need to make your application stand out while the employer decides if you&apos;re a good match for the job. However, it&apos;s also an opportunity for you to make a good impression and show that you&apos;re the ideal candidate.                    </p>
                </div>
                <Image  width={700} height={350} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" property="true" src="/images/interview-web.jpg" className="relative shadow-banner-img right-12 -bottom-28" alt="resignation"/>
            </div>
